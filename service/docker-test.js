...
console.error(colors('blue', `docker run --net=host --name chatgpt-web-service-test -d -v /etc/localtime:/etc/localtime:ro --env PORT=33002 --env AUTH_SECRET_KEY=true --env HTTPS_PROXY=http://127.0.0.1:15777 --env DATASET_MYSQL_USER=dataset --env DATASET_MYSQL_PASSWORD=dataset2023 --env DATASET_MYSQL_DATABASE=dataset --env SOCKS_PROXY_HOST=127.0.0.1 --env SOCKS_PROXY_PORT=15778 --env OPENAI_API_KEY=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 --env SALAI_TOKEN=MTA2MjY3OTYzMTI1NTMxMDMzNw.GRY1Nr.dHPT1Xumivz-90yAucReStOEDiGw3_3Dn3Cxlc --env SERVER_ID=662267976984297473 --env CHANNEL_ID=997271873551351808 127.0.0.1:5000/chatgpt-web-service-test:${packageJsonConfig.version}`))

// 不用注册用户的服务版本
// console.error(colors('blue', `docker run --net=host --name chatgpt-web-service-test -d -v /etc/localtime:/etc/localtime:ro --env PORT=33002 --env HTTPS_PROXY=http://127.0.0.1:15777 --env DATASET_MYSQL_USER=dataset --env DATASET_MYSQL_PASSWORD=dataset2023 --env DATASET_MYSQL_DATABASE=dataset --env SOCKS_PROXY_HOST=127.0.0.1 --env SOCKS_PROXY_PORT=15778 --env OPENAI_API_KEY=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 127.0.0.1:5000/chatgpt-web-service-test:${packageJsonConfig.version}`))
// 注册用户的服务版本
