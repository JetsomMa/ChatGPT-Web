      ...
      <div style="width: 100%; display: flex; z-index: 100; align-items: center; flex-direction: column; position: absolute;">
        <div v-if="notionShow" style="position: relative; padding: 5px; color: green; width: 100%; background-color: yellow; opacity: 1;">
          <div style="padding-right: 45px;">
            【网站将长期免费】为了防止您走丢了，找不到我，我特意将本网站封装成了各个平台的应用，以方便您的使用！下载安装应用请看<a href="https://blog.mashaojie.cn/9999/09/08/%E5%9B%BD%E5%86%85%E5%85%8D%E7%BF%BB%E7%9A%84ChatGPT%E5%92%8CMidjourney%E7%BD%91%E7%AB%99/" class="text-blue-500" target="_blank">网站使用指南[2023/06/27]</a>
          </div>
